<?php
    ...
    $_SESSION['user'] = $data;
    echo '<script>alert("Selamat datang, Jangan lupa logout setelah selesai menggunakan halaman ini"); location.href="indexp.php" </script>';
    }else{
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button type ="submit" class="btn btn-primary w-100">Login</a></button>
                                            </div>
                                        </form>
                                    </div>
                                    </div>
